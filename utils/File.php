...
class File {
    ...
    public function __construct(string $fileInput, array $mimeTypes = [], int $maxSize = 0) {
        ...
        */
        ...
        if ($this->file["error"] !== UPLOAD_ERR_OK) {
            switch ($this->file["error"]) {
                ...
                case UPLOAD_ERR_PARTIAL:
                    ...
                    break;                
                default:
                    throw new FileException("No se ha podido subir el archivo");
                    break;
            }
        }
        ...
        //Evitar hackeo (mediante inyeccion de html)
    ...
    public function saveUploadedFile(string $destPath) {
        ...
        */
        if (false === is_uploaded_file($this->file["tmp_name"])) {
            throw new FileException("El archivo no se ha podido subir mediante un formulario");
        }

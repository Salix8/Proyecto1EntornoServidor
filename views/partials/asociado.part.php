...
<div class="last-box row">
    <div class="col-xs-12 col-sm-4 col-sm-push-4 last-block">
        <div class="partner-box text-center">   
            ...
            <?php foreach ($asociados as $itemAsociado):?>
                <ul class="list-inline">
                    <li><img src="<?=$itemAsociado->getUrlLogo()?>" alt="<?=$itemAsociado->getDescription()?>" title="<?=$itemAsociado->getDescription()?>"></li>
                    <li><?=$itemAsociado->getNombre()?></li>
                </ul>
            <?php endforeach ?>
            </div>
        </div>

     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse navbar-right" id="menu">
            <ul class="nav navbar-nav">
                <li class="<?= (esOpcionMenuActiva("index")? "active" : ""); ?> lien"><a href="<?= (esOpcionMenuActiva("index")? "#" : "/index.php"); ?>"><i class="fa fa-home sr-icons"></i> Home</a></li>
                ...
                <li class="<?= (esOpcionMenuActiva("blog")? "active" : ""); ?> lien"><a href="<?= (esOpcionMenuActiva("blog")? "#" : "/blog.php"); ?>"><i class="fa fa-file-text sr-icons"></i> Blog</a></li>
